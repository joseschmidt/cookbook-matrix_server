...
#----------------------------------------- link/directory/link/file/template[]
...
#------------------------------------------ template[/home/jeeves/.ssh/config]
...
#------------------------------- template[/home/jeeves/.ssh/matrix_deploy_key]
